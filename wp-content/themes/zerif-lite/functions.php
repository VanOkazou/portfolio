...
function zerif_scripts() {    
    ...
    /* Script perso */
    wp_enqueue_script('script', get_stylesheet_directory_uri() . '/js/script.js', array("jquery"), '1', true);
			...
			<?php if( !empty($instance['image_uri']) && ($instance['image_uri'] != 'Upload Image') ) { ?>
				...
				<div class="service-icon">
					...
					<?php if( !empty($instance['link']) ) { ?>
						...
						<a href="<?php echo $instance['link']; ?>"><i class="pixeden" style="background:url(<?php echo esc_url($instance['image_uri']); ?>) no-repeat center; background-size: cover; width:100%; height:100%;"></i> <!-- FOCUS ICON--></a>
					
					<?php } else { ?>
					
						<i class="pixeden" style="background:url(<?php echo esc_url($instance['image_uri']); ?>) no-repeat center;background-size: cover; width:100%; height:100%;"></i> <!-- FOCUS ICON-->
						...
						?>
							...
							<div class="service-icon">
								...
								<?php if( !empty($instance['link']) ) { ?>
									...
									<a href="<?php echo $instance['link']; ?>" target="_blank"><i class="pixeden" style="background:url(<?php echo esc_url($zerif_ourfocus_custom_media_id[0]); ?>) no-repeat center;width:100%; height:100%;"></i> <!-- FOCUS ICON--></a>
    ...
    register_post_type(
        ...
        array(
            ...
            'labels' => array(
                ...
                'not_found_in_trash' => 'Partenaire non trouvé dans la corbeille'
                ),
            'public' => true,
