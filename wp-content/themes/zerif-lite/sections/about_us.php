	...
	<div class="container">
		...
		<div class="col-lg-<?php echo $colCount; ?> col-md-<?php echo $colCount; ?> column zerif-rtl-skills ">
			...
			<ul class="skills" data-scrollreveal="enter right after 0s over 1s">
				...
				<li>
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 291.9 291.9" enable-background="new 0 0 291.9 291.9" xml:space="preserve">
						<g id="Calque_3">
